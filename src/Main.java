...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        waiter.makeAnOrder(menu, new Order("12.11.22", "14:31", table1, new String[]{"cake", " steak", "apple juice"}));
        System.out.println(table1.status);
        waiter.makeAnOrder(menu, new Order("12.11.22", "15:00", table2, new String[]{"cake", " steak", "apple juice"}));
        waiter.makeAnOrder(menu, new Order("12.11.22", "15:00", table2, new String[]{"cake", " steak", "apple juice"}));
        waiter.makeAnOrder(menu, new Order("12.11.22", "15:00", table2, new String[]{"cake", " steak", "apple juice"}));
